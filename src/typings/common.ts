...
export type StyledStatelessProps<P extends object, T extends object> = P & { theme?: T }
export type StyledOtherProps<P extends object, T extends object, R> = StyledStatelessProps<P, T> & {
  innerRef?: R
}
